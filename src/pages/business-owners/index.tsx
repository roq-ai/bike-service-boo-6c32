...
export function BusinessOwnerListPage(props: BusinessOwnerListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: [
            ...
            'business_address.contains',
            'business_city.contains',
            'business_state.contains',
            'business_zip_code.contains',
          ],
          ...params.filters,
        },
        'business_owner',
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'business_city', header: 'Business City', accessorKey: 'business_city' },
    { id: 'business_state', header: 'Business State', accessorKey: 'business_state' },
    { id: 'business_zip_code', header: 'Business Zip Code', accessorKey: 'business_zip_code' },
