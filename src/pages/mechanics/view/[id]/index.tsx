...
import { useMechanicFindFirst, useRoqClient } from 'lib/roq';

import { MechanicInterface } from 'interfaces/mechanic';

function MechanicViewPage() {
  ...
  const { data, error, isLoading } = useMechanicFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('mechanic', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/mechanics/edit/${id}`} passHref legacyBehavior>
                    <Button
