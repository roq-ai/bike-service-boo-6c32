...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Bike service booking online`}</title>

        <meta
          name="description"
          content="Bike service booking online - Your trusted partner at Garage, where we understand your needs and provide top quality, efficient services for your bikes."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1522758971460-1d21eed7dc1d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnYXJhZ2V8ZW58MHx8fHwxNjk3NTM2Njg5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Bike service booking online`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Bike service booking online - Your trusted partner at Garage, where we understand your needs and provide top quality, efficient services for your bikes.`}
            </Text>
            <Box
